...
const ChatbotWidget = () => {
  ...
  return (
    <>
      {/* Chatbot Window */}
      {isOpen && (
        <div className="fixed bottom-20 right-4 w-96 h-[500px] bg-white rounded-2xl shadow-2xl border border-gray-200 z-50 flex flex-col overflow-hidden animate-fadeIn">
          {/* Header */}
          <div className="bg-gradient-to-r from-blue-600 to-purple-600 text-white p-4 flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-xs text-blue-100">Ask about Alzheimer's & Parkinson's</p>
              </div>
            </div>
            <button
              ...
              <div className="space-y-2">
                ...
                {quickQuestions.map((question, index) => (
                  <button
                    ...
                    className="w-full text-left p-2 text-xs bg-blue-50 hover:bg-blue-100 rounded-lg text-blue-700 transition-colors duration-200"
                  >
                    {question}
                  </button>
                ))}
          ...
          <div className="p-4 border-t border-gray-200">
            <div className="flex space-x-2">
              <input
                ...
                placeholder="Ask about Alzheimer's or Parkinson's..."
