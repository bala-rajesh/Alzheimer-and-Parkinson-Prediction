      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <nav className="-mb-px flex space-x-4 sm:space-x-8 overflow-x-auto">
              ...
              >
                <div className="flex items-center space-x-1 sm:space-x-2">
                  ...
                  <span className="hidden sm:inline">Alzheimer's Disease</span>
                  <span className="sm:hidden">Alzheimer's</span>
                </div>
              </button>
              <button
              ...
              >
                <div className="flex items-center space-x-1 sm:space-x-2">
                  ...
                  <span className="hidden sm:inline">Parkinson's Disease</span>
                  <span className="sm:hidden">Parkinson's</span>
                </div>
              </button>
            </nav>
          </div>
        ...
        <div className="animate-fadeIn">
          ...
          <div className="bg-white rounded-2xl shadow-lg p-4 sm:p-6 lg:p-8 mb-6 sm:mb-8">
            ...
            <div className="mt-4 sm:mt-6">
              ...
              <div className="flex justify-center">
                <div className="relative rounded-lg overflow-hidden shadow-md bg-gray-100 w-full sm:w-5/6 lg:w-3/4 max-w-2xl">
                  <video
                    key={activeTab}
                    controls
                    preload="metadata"
                    className="w-full h-48 sm:h-64 lg:h-80 bg-black"
                  ...
                  >
                    ...
                    <p className="text-center text-gray-500 p-4 text-sm">
                      ...
                      >
                        Download{" "}
                        {activeTab === "alzheimer" ? "Alzheimer" : "Parkinson"}{" "}
                        video
                      </a>
                    </p>
                  </video>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 lg:gap-8">
            ...
            <div className="bg-white rounded-2xl shadow-lg p-4 sm:p-6 lg:p-8 hover:shadow-xl transition-shadow duration-300">
          ...
          {/* Call to Action */}
          <div className="mt-6 sm:mt-8 bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl p-4 sm:p-6 lg:p-8 text-white">
            <div className="text-center">
              ...
              <button
                ...
                className="bg-white text-blue-600 px-6 sm:px-8 py-2 sm:py-3 rounded-full font-semibold hover:shadow-lg transform hover:scale-105 transition-all duration-200 text-sm sm:text-base"
              >
                Start Analysis
              </button>
            </div>
